...
If an abstract subgroup $A$ of a Lie group $G$ has a manifold structure which makes $(A, \iota)$ into an immersed (sub-)manifold of $G$, where $\iota$ is the inclusion map, then it has a unique manifold structure, and in this manifold structure, $A$ is a Lie group and hence, $(A, \iota)$, is a Lie subgroup of $G$.
\end{theorem}
...
% This we call being an involutive distribution. 
